<template>
  <tar-bar>
    <tar-bar-item path="/home" activeStyle="red">
    ...
    <tar-bar-item path="/category" activeStyle="red">
    ...
    <tar-bar-item path="/cart" activeStyle="red">
    ...
    <tar-bar-item path="/me" activeStyle="red">
